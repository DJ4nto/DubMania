...
revoke all on function
  public.set_player_round_ready(uuid, uuid)
from public;
...
begin
  ...
  set
    ...
    recording_deadline_at =
      scheduled_time
      + make_interval(
          secs => video_duration_seconds + 20
        )
...
revoke all on function
  public.schedule_round_start(uuid)
from public;
...
revoke all on function
  public.confirm_round_started(uuid, uuid)
from public;
...
revoke all on function
  public.cancel_round_preparation(uuid)
from public;
